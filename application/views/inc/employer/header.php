...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('base_url');?>/assets/dashboard/css/dashboard.css">
                ...
                <div class="dropdown header-top-account">
                  ...
                  <div class="account-card">
                    ...
                    <ul class="account-item-list">
                      ...
                      <li><a href="<?= site_url("employer-account-settings") ?>"><span class="ti-settings"></span>Settings</a></li>
            ...
            <nav class="navbar navbar-expand-lg cp-nav-2">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                  ...
                  <li class="menu-item post-job"><a title="Job Board" href="<?php echo $this->config->item('base_url');?>/jobs"><i class="fa fa-address-card"></i>Job Board</a></li>
                  <li class="menu-item post-job"><a title="Blog" href="<?php echo $this->config->item('base_url');?>/blogs"><i class="fas fa-newspaper"></i>Blog</a></li>
