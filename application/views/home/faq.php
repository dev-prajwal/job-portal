            ...
            <div class="white-bg others-block">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-lg-10">
                      <ul class="nav nav-tabs faq-tab" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="true">About Blogs</a>
                        </li>
                      </ul>
              ...
              <div class="padding-bottom-60">
                <div class="quick-contact">
                  <div class="icon">
                    <img src="<?php echo $this->config->item('base_url');?>/assets/images/chat-icon.png" class="img-fluid" alt="">
                  </div>
