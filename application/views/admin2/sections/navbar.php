          ...
          <div class="col">
            ...
            <nav class="navbar navbar-expand-lg cp-nav-2">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                  <li class="menu-item active"><a title="Home" href="home-1.html">Dashboard</a></li>
                  <li class="menu-item dropdown">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">Approvals</a>
                    <ul  class="dropdown-menu">
                      <li class="menu-item"><a  href="job-listing.html">Job Post Approval</a></li>
                      <li class="menu-item"><a  href="job-listing-with-map.html">Job Company Approval</a></li>
                  ...
                  <li class="menu-item dropdown">
                    <a title="" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">Blogs</a>
                    <ul  class="dropdown-menu">
                      <li class="menu-item"><a  href="employer-details.html">View Blogs</a></li>
                      <li class="menu-item"><a  href="employer-dashboard-post-job.html">Write a Blog</a></li>
                    </ul>
                  </li>
                  <li class="menu-item dropdown">
