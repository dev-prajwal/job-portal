...
<head>
	...
	<?php include_once 'pages/sections/include-css.php' ;?>

</head>
<?php include_once 'pages/sections/preloader.php' ;?>
<!-- HK Wrapper -->
<div class="hk-wrapper hk-vertical-nav hk-icon-nav">
	<?php include_once 'pages/sections/topnav.php' ;?>
	<?php include_once 'pages/sections/sidebar.php' ;?>
...
<!-- /Main Content -->
    ...
    <!-- /HK Wrapper -->
<?php include_once 'pages/sections/footer_jquery.php' ;?>
