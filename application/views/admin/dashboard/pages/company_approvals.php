								...
								<div class="table-wrap">
									...
									?> 
										...
										<table class="table table-sm table-hover mb-0">
											...
											<?php $row = 1;  foreach ($companies as $companie) { ?>

											<tr>
												<td><?php echo $row;?></td>
												<td><?php echo $companie['company_name'];?></td>
												<td><?php echo $companie['company_type'];?></td>
												<td>
												<a href="<?= base_url('/admin/company_approve/').$companie['company_id'] ;?>" class="btn btn-success" ><i class="fas fa-check"></i></a>
												<a href="<?= base_url('/admin/company_disapprove/').$companie['company_id'] ;?>" class="btn btn-danger" ><i class="fas fa-ban"></i></a>
												</td>
